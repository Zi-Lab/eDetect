function [ UpdatedLabels  ] = track_frame_linking(id , prediction , info , coordinate , touch_border , reject , max_shift)
...
if max_shift == 0
    ...
    x = fmincon(@(x)calculate_cost_distances(x, m1 , m2 , reject) , [0 0] , [],[],[],[] , [-max_shift,-max_shift] , [max_shift,max_shift],[],options);
end
m2_ = m2 + x;
%%
